...
export class Git {
   ...
   * @param {string[]} [extra] more paths to include, for example ignored files copied into the folder
   */
  async fingerprint(extra = []) {
    ...
    for (const e of extra) paths.push(Buffer.from(e))
