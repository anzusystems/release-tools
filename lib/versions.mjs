...
/**
 * The released stable versions of the lines newer than the line of a version, by line.
 * @param {string} version
 * @param {Iterable<string>} released
 * @returns {Map<string, string[]>}
 */
export function newerLines(version, released) {
