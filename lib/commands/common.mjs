 ...
 * @param {Context} ctx
 * @param {number} number
 * @param {{ allowBypass?: boolean, expectHead?: string, bypassConfirmed?: boolean }} [options] bypassConfirmed: the bypass
 *   was confirmed for this release before its tag (merge after publishing without asking again)
